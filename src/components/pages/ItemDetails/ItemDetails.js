    ...
    return (
        <Container>
            <Card>
                ...
                <Card.Body>
                    <Card.Title className="cardTitle">{singleItem?.cakeName}</Card.Title>
                    <Card.Text className="cardDisciption">
                        {singleItem?.title}
                    </Card.Text>
                    <Card.Text className="cardDisciption">
                        {singleItem?.cakeDiscription}
                    </Card.Text>
                    <div className="row">
                        <Card.Text className="cardPrice col-sm-6 col-md-6 col-lg-3">Price :
                            <span>{` ${singleItem?.price}`}</span>
                        </Card.Text>
                        <Card.Text className="cardPrice col-sm-6 col-md-6 col-lg-3">Weight :
                            <span>{` ${singleItem?.weight}`}</span>
                        </Card.Text>
                        <Card.Text className="cardPrice col-sm-6 col-md-6 col-lg-3">number of Layer :
                            <span>{` ${singleItem?.layerNumber}`}</span>
                        </Card.Text>
